# Linearize
Construct a linear, no-fork, best version of the Pion blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install pion_hash

https://github.com/pioncoin/pion_hash
...
JSON-RPC server. Running `piond` or `pion-qt -server` will be sufficient.
...
* `input`: piond blocks/ directory containing blkNNNNN.dat
