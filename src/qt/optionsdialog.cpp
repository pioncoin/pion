    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("PION-light"), QVariant("light"));
    // Disable other themes
    // ui->theme->addItem(QString("PION-light-hires"), QVariant("light-hires"));
    // ui->theme->addItem(QString("PION-light-retro"), QVariant("light-retro"));
    // ui->theme->addItem(QString("PION-light-hires-retro"), QVariant("light-hires-retro"));
    // ui->theme->addItem(QString("PION-blue"), QVariant("drkblue"));
    // ui->theme->addItem(QString("PION-Crownium"), QVariant("crownium"));
    // ui->theme->addItem(QString("PION-traditional"), QVariant("trad"));
