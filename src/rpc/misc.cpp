...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total pion balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized pion balance of the wallet\n"
...
UniValue debug(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "pion|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use '+' to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "pion")
            + HelpExampleRpc("debug", "pion+net")
        );
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given pion address.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The pion address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The pion address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"")
            + HelpExampleRpc("validateaddress", "\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Pion address and we have full public key:
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are pion addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) pion address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The pion address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"PMUDCu3YHkvdqy8qQRu96KPjGav8geZzPm\"]}")
        );
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Pion features */
    { "pion",               "mnsync",                 &mnsync,                 true,  {} },
    { "pion",               "spork",                  &spork,                  true,  {"value"} },
