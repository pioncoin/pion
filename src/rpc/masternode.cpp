...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Pion address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "pion",               "masternode",             &masternode,             true,  {} },
    { "pion",               "masternodelist",         &masternodelist,         true,  {} },
    { "pion",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "pion",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "pion",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "pion",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
