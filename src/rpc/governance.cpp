...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in pion.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("pion.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Pion features */
    { "pion",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "pion",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "pion",               "gobject",                &gobject,                true,  {} },
    { "pion",               "voteraw",                &voteraw,                true,  {} },
