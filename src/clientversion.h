...
//! These need to be macros, as clientversion.cpp's and pion*-res.rc's voodoo requires it
...
/**
 * piond-res.rc includes this file, but it cannot cope with real c++ code.
