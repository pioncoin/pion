...
public:
    ...
    CAmount GetDustThreshold(const CFeeRate &minRelayTxFee) const
    {
        ...
        // i.e. total is 148 + 32 = 182 bytes. Default -minrelaytxfee is 1000 puffs per kB
        // and that means that fee per spendable txout is 182 * 1000 / 1000 = 182 puffs.
        // So dust is a spendable txout less than 546 * minRelayTxFee / 1000 (in puffs)
        // i.e. 182 * 3 = 546 puffs with default -minrelaytxfee = minRelayTxFee = 1000 puffs per kB.
