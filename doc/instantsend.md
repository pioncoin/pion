...
This mechanism has been integrated into Bitcore-Node-Pion which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/pioncoin/insight-api-pion#web-socket-api](https://github.com/pioncoin/insight-api-pion#web-socket-api)
* API: [https://github.com/pioncoin/insight-api-pion#instantsend-transactions](https://github.com/pioncoin/insight-api-pion#instantsend-transactions)
...
By default, the Pion Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pion Core daemon:
