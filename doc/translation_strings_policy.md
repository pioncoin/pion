...
This document provides guidelines for internationalization of the Pion Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pion_en.ts` remains unchanged.
